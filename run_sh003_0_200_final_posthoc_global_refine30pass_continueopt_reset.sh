...
WORK_DIR="outputs/SH003_0_200_final_W20_R30_B100_th010_global_refine30pass_continueopt_reset"
OUTPUT_NAME="incremental_SH003_0_200_final_W20_R30_B100_th010_global_refine30pass_continueopt_reset"
mkdir -p "$WORK_DIR"
...
PIPELINE_GLOBAL_REFINE_RESET_OPACITY=1 \
