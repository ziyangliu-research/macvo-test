...
# Prioritized final subset:
#   SE000-SE003 + SH000-SH003 (8 sequences)
#
# Existing SE000/SE001 seed0 quality results are reused.
# Phase 1: run ONE quality experiment (seed0) for the six missing targets:
#          SE002 SE003 SH000 SH001 SH002 SH003
# Phase 2: after all quality targets are attempted, run ONE timing-only experiment
#          for all eight sequences. Existing timing results are skipped.
#
# Quality protocol:
...
# Timing protocol:
#   no PSNR/SSIM/LPIPS/ATE rendering/evaluation
#   online FPS / online wall time + 10-pass refinement wall time
#
# Restart-safe: completed outputs are skipped.
...
# -----------------------------------------------------------------------------
# Phase 1: prioritize one usable quality result for all missing target sequences.
# SE000/SE001 quality_seed0 are intentionally reused from the previous launcher.
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# Phase 2: timing-only once for the complete 8-sequence subset.
# Any SE000/SE001 timing already finished by the old launcher is skipped.
# -----------------------------------------------------------------------------
echo
