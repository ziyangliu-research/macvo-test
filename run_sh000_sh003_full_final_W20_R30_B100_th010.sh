...
# Final SH000-SH003 benchmark.
# One run per sequence provides both:
#   1) strict 8:2 Train/Test quality metrics from final evaluation, and
#   2) FPS excluding metric-rendering time, derived from frame_timing_log.json.
#
# Frozen backend configuration:
#   W=20, replay ratio=0.30, B=100, maintenance=50, opacity threshold=0.10.
...
RUNNER="run_pipeline_execution_benchmark_repro_final_eval_only.py"
...
run_case() {
  ...
  local name="${seq}_full_final_W20_R30_B100_th010"
  ...
  echo "strict 8:2 | W20 R30 B100 M50 Th=.10"
  echo "final evaluation ON; intermediate metric rendering OFF"
  echo "================================================================"
...
echo
echo "Final benchmark finished. Summarize with:"
echo "  python summarize_sh000_sh003_full_final_W20_R30_B100_th010.py"
