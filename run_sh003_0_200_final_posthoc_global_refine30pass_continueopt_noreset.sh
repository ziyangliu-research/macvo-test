...
WORK_DIR="outputs/SH003_0_200_final_W20_R30_B100_th010_global_refine30pass_continueopt_noreset"
OUTPUT_NAME="incremental_SH003_0_200_final_W20_R30_B100_th010_global_refine30pass_continueopt_noreset"
mkdir -p "$WORK_DIR"
...
PIPELINE_GLOBAL_REFINE_PASSES=30 \
PIPELINE_GLOBAL_REFINE_EVAL_EVERY=500 \
PIPELINE_GLOBAL_REFINE_RESET_OPACITY=0 \
PIPELINE_GLOBAL_REFINE_SEED=0 \
CUDA_VISIBLE_DEVICES=0 \
TORCH_COMPILE_DISABLE=1 \
python run_pipeline_execution_benchmark_repro_posthoc_global_refine_continue_optimizer.py \
  --mode serial \
  --with_pose_metrics \
