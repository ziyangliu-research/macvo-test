...
WORK="${WORK:-outputs/p004_teaser_full}"
NAME="${NAME:-incremental_P004_teaser_full}"
...
cat <<EOF
======================================================================
TartanAir V2 House/P004 | FULL qualitative teaser run
Frames       : [0,$END_INDEX) = $END_INDEX frames
Mapping      : all frames (no held-out split in this qualitative run)
...
Initial teaser camera:
  ...
  render size : 960x540
  normalized K: fx=.25 fy=.35 cx=.5 cy=.5  (same wide P001 FoV)
======================================================================
EOF
...
echo
echo "======================================================================"
echo "[done] P004 full teaser run: $OUT"
